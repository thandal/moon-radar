...
rx_mid_time_s = rx_start_time_s + rx_duration / 2.0
...
lt_rx_mid, dlt_rx_mid = get_bck_dlts(rx_mid_time_s)
lt_rx_end, dlt_rx_end = get_bck_dlts(rx_end_time_s)

freq = 1299.5e6
doppler_start = -dlt_rx_start * freq
doppler_end = -dlt_rx_end * freq
doppler_mid_true = -dlt_rx_mid * freq

doppler_rate = (doppler_end - doppler_start) / rx_duration
doppler_mid_linear = doppler_start + doppler_rate * (rx_duration / 2.0)

print(f"doppler_mid_true:   {doppler_mid_true} Hz")
print(f"doppler_mid_linear: {doppler_mid_linear} Hz")
print(f"Error at midpoint:  {doppler_mid_true - doppler_mid_linear} Hz")
