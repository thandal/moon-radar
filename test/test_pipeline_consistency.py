...
DATA_ROOT = os.path.join(os.path.dirname(__file__), "..", "notebooks",
...
check("closure residual shift", abs(m1["shift_refined"]), 2.0, "samples")
check("closure residual centroid", abs(m1["f_centroid"]), 0.05, "Hz")
